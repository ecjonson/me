        ...
        <ViewTransition default="vt-page">
            <div className="relative">
                ...
                <Link
                    ...
                    aria-label="Close"
                    prefetch
                    className="vt-close fixed right-4 top-4 z-50 flex h-9 w-9 items-center justify-center rounded-full border border-gray-200 bg-gray-100 text-lg leading-none text-accent transition-colors hover:text-gray-600 lg:hidden dark:bg-gray-800 dark:text-gray-300 dark:border-gray-800 "
                >
                    ×
                </Link>
